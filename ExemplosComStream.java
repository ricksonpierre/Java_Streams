...
public class ExemplosComStream {
    public static void main(String[] args) {
        ...
        System.out.println("Contém a letra R no nome: "+estudantes.stream().filter((estudante) ->
        ...
        System.out.println("Retorna os três primeiros elementos: "+ estudantes.stream().limit(3)
